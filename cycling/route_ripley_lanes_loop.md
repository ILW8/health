...
## Turn-by-turn (km from the GPX)

| km | Waypoint | Notes |
|---|---|---|
| 0 | Home / Raynes Park | Coombe Lane West → Coombe Lane → Kingston Hill → London Road into Kingston. Urban, keep it Z1 as a warm-up. |
| 6.5 | Kingston centre | The route threads the pedestrianised centre (Clarence Street → Market Place, cobbles) and exits south down the old High Street onto the **A307 Portsmouth Road**. Fine at dawn; nav may go quiet for ~500 m. |
| 7.2 | Portsmouth Road | Heading south along the river. |
| 10 | Thames Ditton / Long Ditton | Stay on Portsmouth Road. |
| 13.4 | Esher | Continue on the A307 through Esher and across Esher Common. **Busiest section of the ride** (Esher → Cobham): fast traffic, but a wide road and a standard club-run road. Earlier start = quieter. |
| 19.1 | Cobham, A307/A245 junction | The A307 (Fairmile / Portsmouth Road) ends here. **Turn left onto Between Streets**, heading east into town. |
| 19.6 | Cobham centre | After ~500 m, at the junction where Between Streets meets the High Street, **turn right onto Downside Bridge Road**, heading south. St Andrew's church is on the left shortly after; then over Downside Bridge. Traffic drops away here. *(Earlier versions of this file said "turn left", then "turn right at the east end of the High Street into Church Street"; both were wrong. This is what the GPX does, confirmed on the road 5 Sep.)* |
| 21.5 | Downside | Cross Downside Common, continue on **Plough Lane → Ockham Lane**, under the M25. Narrow lanes, occasional gravel, watch for horses. |
| 25.7 | Ockham | Bear left onto **Ockham Road North (B2039)**, which dips south-west through Ockham village before swinging north-west to Ripley. |
| 28.2 | **Ripley** (west end) | The route touches the High Street only at its west end and goes straight onto **Newark Lane**. Cafe stop: Pinnocks (High Street) — turn right into the village, a couple of hundred metres off the route. If you're not stopping, at least eat here. |
| 28.5 | Newark Lane | West then north past Newark Priory ruins and over the Wey. Flat and quiet. |
...
Ridden clockwise from 05:41 on a Saturday: almost nobody going the same way (three riders), but 100+ coming the other way, nearly all on the Weybridge → Walton → Hampton Court leg between about 07:45 and 08:30. That's the SW London outbound corridor at peak start time, not evidence that the loop is better counter-clockwise. Start at 08:00 for company, at the cost of a busier Portsmouth Road.
